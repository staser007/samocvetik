<check if="{{isset(@GetAllChangesLot)}}">
    <true>
        <check if="{{count(@GetAllChangesLot) > 0}}">
            <true>
                <form action="../../../index.php" method="post" class="archive_detail_form">
                    ...
                    <div class="form-group text-right">
                        <a href="{{@BASE}}/admin/archive_detail.html?id={{@lot->number}}" class="btn btn-default">Вернуться к списку лотов</a>
                        <a href="{{@BASE}}/admin/archive.html" class="btn btn-default">Вернуться к списку аукционов</a>
                    </div>
                </form>
            </true>
            <false>
                <div class="form-grouptext-right">
                    ...
                    <a href="{{@BASE}}/admin/archive.htm_detail.html?id={{@lot->number}}l" class="btn btn-default">Вернуться к списку лотов</a>
                    <a href="{{@BASE}}/admin/archive.html" class="btn btn-default">Вернуться к списку аукционов</a>
                </div>
            </false>
        </check>
